...
cd canvas-lms
git remote -v
# if there is no upstream then add the following 
...
# do run the server in production mode and do a sanity test on browser 
# to make sure the main screens are working
git push
```
